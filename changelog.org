...
*** Capture target file sync
    - Fixed capture templates that target a startup-synced file so new entries are saved even while viewing another file
    - PR: https://github.com/200ok-ch/organice/pull/1119
...
*** Long-press drag and drop reordering for headers
    ...
    - PR: https://github.com/200ok-ch/organice/pull/1108
...
*** Help/Sample modal for authenticated users
    ...
    - PR: https://github.com/200ok-ch/organice/pull/1106
*** Unseen changelog gift icon in authenticated header
    ...
    - PR: https://github.com/200ok-ch/organice/pull/1107
** Added
*** Auto-continue lists with checkboxes in description editor
    - When pressing Enter in an (unordered) checkbox list, the list
      will be continued with a checkbox
    - The new line has a checkbox with the same checked state as the
      previous one (unchecked, checked, partially checked).

    See [[https://orgmode.org/manual/Checkboxes.html][orgmode manual]] for more information on checkboxes.
...
*** Migrated search parser from pegjs to peggy
    ...
    - PR: https://github.com/200ok-ch/organice/pull/1101
...
*** Harmonize modals for managing headers
    ...
    - PR: https://github.com/200ok-ch/organice/pull/1099
...
See the [[https://organice.200ok.ch/documentation.html#org_habits][documentation]] for more details on habit configuration and usage.
...
PR: https://github.com/200ok-ch/organice/pull/1055

Thank you [[https://github.com/cperl82][cperl82]] for the PR🙏

** Fixed

*** Dropbox sorting

The old Dropbox sorting could do the wrong thing when the sort
comparator is called with the first argument being a file and the
second argument being a folder.

PR: https://github.com/200ok-ch/organice/pull/1054

Thank you [[https://github.com/cperl82][cperl82]] for the PR🙏

*** On Chrome > 137: GitLab sign-in for private repository fails with "Unexpected sign in error, please try again"

PR: https://github.com/200ok-ch/organice/pull/1061

Thank you [[github.com/mcwitt][mcwitt]] for the PR and [[https://github.com/dtvillafana][dtvillafana]] for support and testing🙏
...
Issue: https://github.com/200ok-ch/organice/issues/1052

** Fixed

*** Components/OrgFile/TimestampEditor: Incorrect Timestamp Format

PR: https://github.com/200ok-ch/organice/pull/1053
Thank you [[https://github.com/vHugoObject][vHugoObject]] for the PR🙏
...
PR: https://github.com/200ok-ch/organice/pull/1043
Thank you [[https://github.com/vHugoObject][vHugoObject]] for the PR🙏
...
The fix from yesterday introduced a regression. Now, we have a fix for
the regression and the initial bug report.
...
- Issue: https://github.com/200ok-ch/organice/issues/1044
- Thank you [[https://github.com/chasecaleb][chasecaleb]] for the fix🙏
...
- PR: https://github.com/200ok-ch/organice/pull/1034
- Thank you [[https://github.com/vHugoObject][vHugoObject]] for the PR🙏
...
PR: https://github.com/200ok-ch/organice/pull/1024
...
*** Refactor and unify Docker setup for improved development and production builds
  ...
  - Introduce a multi-stage =Dockerfile=. This file defines distinct
    stages for =base=, =development=, =build=, and =production=,
    ensuring optimized layers and dependencies.
  - The production Docker image is lean, containing only necessary built assets and runtime dependencies.

This significantly simplifies Docker configuration management,
enhances the developer experience when using Docker, and builds upon
earlier work by @rogueai to create lean production images.

The PR is: https://github.com/200ok-ch/organice/pull/1023
